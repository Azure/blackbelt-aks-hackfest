...
1. Command-Line Proxy
    ...
    * Run ```az group list -o table``` in order to retrieve the name of the resource group for your Azure account and then put it in the NAME variable ```NAME=<Resource_Group_Name_Goes_Here>```.
