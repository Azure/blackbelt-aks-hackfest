...
function kubeJobRunner (config, k) {
    ...
    k.tasks = [
        `kubectl set image deployment/heroes-web-deploy heroes-web-cntnr=krypton.azurecr.io/azureworkshop/rating-web:${config.get("imageTag")}`
    ]
}
