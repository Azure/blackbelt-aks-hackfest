...
4. List the pods in the cluster (`kubectl get pods`). You should see Brigade worker and jobs pods running.
5. Also you should see a new image created in ACR in the rating-web repository with tag **master-xxxxx** 
